...
void loop()
{
  ...
  int speedd = analogRead(A0);
  SET_AEMEngine0_EngineSpeed(data, speedd * 32);
  SET_AEMEngine0_CoolantTemp(data, speedd / 5);
  byte sndStat = CAN0.sendMsgBuf(ID_AEMEngine0, 1, 8, data);
  if(sndStat == CAN_OK){
