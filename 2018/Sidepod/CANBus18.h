 ...
 * CAN DBC C-Headers
 *
 * These headers were generated by dbc2c.awk on Wed Apr 25 17:38:22 EDT 2018.
 *
...
/**
 * @defgroup ECU_REAR_CAN_CONTROLLER Electronics Control Unit REAR_CAN_CONTROLLER
 *
 * This ECU was defined in \ref DB_-.
 *
 * TX messages:
 * - \ref MSG_RearController0
 *
 * RX signals:
 *
 * @ingroup DB_-
...
/**
 * @defgroup MSG_RearController0 Message RearController0 (0x1f09fff)
 *
 * Sent by \ref ECU_REAR_CAN_CONTROLLER.
 *
 * Contains signal groups:
 *
 * Contains signals:
 * - \ref SIG_RearController0_RearBrakePressure
 * - \ref SIG_RearController0_FrontBrakePressure
 *
 * @ingroup ECU_REAR_CAN_CONTROLLER
 * @{
 */

/**
 * Message RearController0 configuration tuple.
 */
#define MSG_RearController0                         0x1f09fff, 1, 8

/**
 * Message RearController0 id.
 */
#define ID_RearController0                          0x1f09fff

/**
 * Message RearController0 extended id bit.
 */
#define EXT_RearController0                         1

/**
 * Message RearController0 Data Length Count.
 */
#define DLC_RearController0                         8

/**
 * Message RearController0 cycle time.
 */
#define CYCLE_RearController0                       20

/**
 * Message RearController0 fast cycle time.
 */
#define FAST_RearController0                        0

/**
 * Initialise message RearController0 buffer.
 *
 * @param buf
 *  The can message buffer to initialise
 */
#define INIT_RearController0(buf) { \
  INITSIG_RearController0_RearBrakePressure(buf); \
  INITSIG_RearController0_FrontBrakePressure(buf); \
}
...
/**
 * @defgroup SIG_RearController0_RearBrakePressure Signal RearBrakePressure of Message RearController0 (0x1f09fff)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_RearController0
 * @{
 */
 ...
 *
 * @deprecated
 *  Use \ref SET_RearController0_RearBrakePressure and \ref GET_RearController0_RearBrakePressure instead.
 */
#define SIG_RearController0_RearBrakePressure        0, 0, 0, 10

/**
 * Signal RearBrakePressure setup tuple.
 *
 * @deprecated
 *  Use \ref INITSIG_RearController0_RearBrakePressure or \ref INIT_RearController0 instead.
 */
#define SETUP_RearController0_RearBrakePressure      0, 0, 0, 10, 0
 ...
 *  The raw signal
 */
#define GET_RearController0_RearBrakePressure(buf) (0 \
 ...
 */
#define SET_RearController0_RearBrakePressure(buf, val) { \
  buf[0] &= ~(0xff << 0); \
 ...
 *  The can message buffer to initialise
 */
#define INITSIG_RearController0_RearBrakePressure(buf) \
  SET_RearController0_RearBrakePressure(buf, 0)
 ...
 */
#define CALC_RearController0_RearBrakePressure(x, fmt) \
  ((x) * fmt * 8192 / 1677 + fmt * 3)

/**
 * Signal RearBrakePressure raw initial value.
 */
#define START_RearController0_RearBrakePressure      0

/**
 * Signal RearBrakePressure raw minimum value.
 */
#define MIN_RearController0_RearBrakePressure        0

/**
 * Signal RearBrakePressure raw maximum value.
 */
#define MAX_RearController0_RearBrakePressure        1023

/**
 * Signal RearBrakePressure raw offset value.
 */
#define OFF_RearController0_RearBrakePressure        1
...
/**
 * @defgroup SIG_RearController0_FrontBrakePressure Signal FrontBrakePressure of Message RearController0 (0x1f09fff)
 *
 * Received by the ECUs:
 *
 * @ingroup MSG_RearController0
 ...
 *
 * @deprecated
 *  Use \ref SET_RearController0_FrontBrakePressure and \ref GET_RearController0_FrontBrakePressure instead.
 */
#define SIG_RearController0_FrontBrakePressure        0, 0, 10, 10

/**
 * Signal FrontBrakePressure setup tuple.
 *
 * @deprecated
 *  Use \ref INITSIG_RearController0_FrontBrakePressure or \ref INIT_RearController0 instead.
 */
#define SETUP_RearController0_FrontBrakePressure      0, 0, 10, 10, 0
 ...
 *  The raw signal
 */
#define GET_RearController0_FrontBrakePressure(buf) (0 \
 ...
 *  The raw value to set the signal to
 */
#define SET_RearController0_FrontBrakePressure(buf, val) { \
  buf[1] &= ~(0x3f << 2); \
 ...
 *  The can message buffer to initialise
 */
#define INITSIG_RearController0_FrontBrakePressure(buf) \
  SET_RearController0_FrontBrakePressure(buf, 0)
 ...
 *  The signal value as a human readable number
 */
#define CALC_RearController0_FrontBrakePressure(x, fmt) \
  ((x) * fmt * 8192 / 1677 + fmt * 3)

/**
 * Signal FrontBrakePressure raw initial value.
 */
#define START_RearController0_FrontBrakePressure      0

/**
 * Signal FrontBrakePressure raw minimum value.
 */
#define MIN_RearController0_FrontBrakePressure        0

/**
 * Signal FrontBrakePressure raw maximum value.
 */
#define MAX_RearController0_FrontBrakePressure        1023

/**
 * Signal FrontBrakePressure raw offset value.
 */
#define OFF_RearController0_FrontBrakePressure        1
